...
const PropertyModel = new mongoose.Schema({
  parcelId: { type: String, require: true, },
  municipality: { type: String, required: true, },
  address: { type: String, require: true, },
  ownerName: { type: String, required: true, },
  ownerCode: { type: String, required: false },
  school: { type: String, required: true, },
  recordingDate: { type: String, required: false, },
  lotArea: { type: Number, required: false, },
  salePrice: { type: Number, required: false, },
  fullMarketValues: MarketValueModel,
  countyAssessedValues: AssessedValueModel,
  searchedBy: { type: mongoose.Schema.Types.ObjectId, ref: "User", },
